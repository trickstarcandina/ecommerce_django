...
urlpatterns = [
    ...
    path('home', views.customer_home_without_login,name='home'),
    path('customer-drinks-without-login', views.customer_drinks_view_without_login,name='customer-drinks-without-login'),
    path('customer-cakes-without-login', views.customer_cakes_view_without_login,name='customer-cakes-without-login'),
    ...
    path('customerlogin_addtocart/<int:pkproduct>', views.login_with_add_to_cart, name='customerlogin_addtocart'),
